 	...
 	<li class="flex-item">
  	...
  	<li class="flex-item">
		...
		<a href="mailto:seansche@usc.edu" target="_top">seansche@usc.edu</a><br>
  		<a href="https://www.linkedin.com/in/seanshinpengcheng/" target="_top">LinkedIn</a><br>
  	...
  	<li class="flex-item">
   	...
   	<li class="flex-item">
		...
		<font size="3">M.S. Student in Computer Science</font><br>
		<a href="mailto:msalaway@usc.edu" target="_top">msalaway@usc.edu</a><br>
      		<a href="www.linkedin.com/in/msalaway" target="_top">LinkedIn</a><br>
